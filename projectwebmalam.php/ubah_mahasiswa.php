...
include 'koneksi.php'; 
$id = $_GET['id']; 
$data = mysqli_query($koneksi,"select * from tbmahasiswa where npm='$id'"); while($d = mysqli_fetch_array($data)){ 
?> 
...
if($d['jekel']=='L') echo 'checked'?>>Laki-laki
<input type="radio" name="jekel" value="P" <?php 
if($d['jekel']=='P') echo 'checked'?>>Perempuan 
</td> 
</tr> 
<tr> 
<td>Jurusan</td> 
